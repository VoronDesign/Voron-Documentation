...
5. Finally, execute the following to download the latest version of the `gcode_shell_command` script
    ...
    ```bash
    wget -O ~/klipper/klippy/extras/gcode_shell_command.py https://github.com/dw-0/kiauh/blob/master/kiauh/extensions/gcode_shell_cmd/gcode_shell_cmd_extension.py
    ```
