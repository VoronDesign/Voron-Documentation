...
//Edit Me:
      //Page ID per Model
      const v0pages = new Array("0", "info", "verifytemp", "verifyheater", "verifyfan", "v0motor", "xyendstop", "v0homing", "v000", "v0endstop", "pid", "v0bedscrews", "zoffset", "finish");
      const v1pages = new Array("0", "info", "verifytemp", "verifyheater", "verifyfan", "v1motor", "xyendstop", "v1homing",  "bedlocating" ,"point00", "zendstop",  "probecheck", "pid", "ztilt", "zoffset", "finish" );
      const v2pages = new Array("0", "info", "verifytemp", "verifyheater", "verifyfan", "v2motor", "xyendstop", "v2homing", "bedlocating", "point00", "zendstop", "probecheck", "pid", "qgl", "zoffset", "finish" );
      ...
      const v0pagename = new Array("Start", "Information", "Verify Temperatures", "Verify Heaters", "Verify Fans", "Motor Checks", "XY Endstop Check", "Homing Check", "0 Point", "Z-Endstop", "PID Tuning", "Bed Leveling", "Z-Offset Adjustment", "Finish Line" );
      const v2pagename = new Array("Start", "Information", "Verify Temperatures", "Verify Heaters", "Verify Fans", "Motor Checks", "XY Endstop Check", "Homing Check", "Bed Locating", "0 Point", "Z Endstop", "Probe Check", "PID Tuning", "Quad Gantry Level", "Z-Offset Adjustment", "Finish Line" );
      const v1pagename = new Array("Start", "Information", "Verify Temperatures", "Verify Heaters", "Verify Fans", "Motor Checks", "XY Endstop Check", "Homing Check", "Bed Locating", "0 Point", "Z Endstop", "Probe Check", "PID Tuning", "Z-Tilt", "Z-Offset Adjustment", "Finish Line" );
      const vswpagename = new Array("Start", "Information", "Verify Temperatures", "Verify Heaters", "Verify Fans", "Motor Checks", "XY Endstop Check", "Probe Check", "Homing Check", "Probe Calibration", "0 Point"  , "PID Tuning", "Z-Offset Adjustment", "Finish Line" );
