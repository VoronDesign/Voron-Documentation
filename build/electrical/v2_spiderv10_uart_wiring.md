...
###### ![](./images/FYSETC_Spider_V1.0_in_UART_mode_PREP.png) {#FYSETC_Spider_V10_in_UART_Mode_PREP}
...
* if using UART (3-wire serial communication) with Pi:
    1. - [ ] [complete the steps for setting up UART Serial communications with the Raspberry Pi](./Fysetc_Spider_RaspberryPi#raspberry-pi){:target="_blank" rel="noopener"}
