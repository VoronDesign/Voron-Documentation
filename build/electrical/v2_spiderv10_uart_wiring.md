---
layout: default
title: "Voron V2 - Fysetc Spider V1.0-V2.0 Wiring in UART Mode"
nav_exclude: true
---

# Voron V2 - Fysetc Spider V1.0-V2.0 Wiring in UART Mode
...
![](./images/FYSETC_Spider_V1.0_in_UART_mode_PREP_150.png)
...
<span> <br> </span>
![](./images/FYSETC_Spider_V1.0_inUARTMode_VoltageSelect_150.png)
...
<span> <br> </span>
![](./images/Voron2.4r2_Wiring_Diagram_FYSETC_Spider_V1.0_in_UART_mode_150.jpg)

* <span style="text-shadow: 0 0 3px #FF0000; font-size: 110%;">Downloadable Fysetc Spider V1.0 Wiring Diagram diagram in .jpg format is [located here](./images/Voron2.4r2_Wiring_Diagram_FYSETC_Spider_V1.0_in_UART_mode_150.jpg)</span>

## Please Ensure the Heat Sinks are Installed Before Use

### MCU in UART Mode with Heat Sinks Installed
<span> <br> </span>
![](./images/FYSETC_Spider_V1.0_in_UART_mode_with_Heatsinks_150.png)
...
![](./images/fysetc-spiderv1.0inUART-ssr-wiring_150.png)

* Downloadable SSR Wiring Diagram for the Fysetc Spider V1.0 board in UART mode (.jpg format) is [located here](./images/fysetc-spiderv1.0inUART-ssr-wiring_150.png)
<span> <br> </span>
